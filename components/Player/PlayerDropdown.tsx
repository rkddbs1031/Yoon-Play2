      ...
      <ul>
        <li>
          <button
            ...
            className='px-4 py-2 flex gap-3 w-full items-center cursor-pointer'
          >
            <LikeIcon fill={'none'} size={18} />
        ...
        <li>
          <button
            ...
            className='px-3 py-2 flex gap-3 w-full items-center cursor-pointer'
          >
